...
esp_err_t pcf8523_app_start(void)
{
    ...
    ESP_RETURN_ON_ERROR(i2c_ext_bus_init(), TAG, "I2C ext init fehlgeschlagen");

    i2c_bus_handle_t bus = i2c_ext_bus_get();
