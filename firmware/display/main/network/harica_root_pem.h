/*
 * GEANT TLS RSA 1 – Intermediate-CA für *.meteoalarm.org
 * Issuer:  HARICA TLS RSA Root CA 2021
 * Gültig:  03. Jan 2025 – 31. Dez 2039
 * Key:     RSA 3072-bit
 *
 * SHA-256: 5B:67:8D:C4:40:95:A5:28:95:B6:3B:31:F2:72:27:F4:
 *          B3:6C:3E:34:74:91:BF:2B:FA:69:18:37:A5:FB:8C:79
 *
 * Als Trust Anchor statt des HARICA-Root-CA verwendet, weil:
 *  - HARICA fehlt in älteren ESP-IDF-CRT-Bundles
 *  - GEANT ist direkte Issuer-CA des Leaf-Certs → kürzere Kette
 *  - RSA-3072-Verifikation braucht weniger internen Heap als RSA-4096
 */
#ifndef HARICA_ROOT_PEM_H
#define HARICA_ROOT_PEM_H

static const char harica_root_pem[] =
    "-----BEGIN CERTIFICATE-----\n"
