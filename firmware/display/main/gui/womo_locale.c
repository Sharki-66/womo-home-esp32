...
static const char* s_strings[WOMO_LOCALE_MAX][STR_MAX] = {
    // German strings
    {
        ...
        [STR_TANKS] = "Tanks:",
        [STR_SENSOR_WAITING] = "Sensor: Warte...",
        [STR_SENSOR_PACKETS] = "Sensor: %lu Pakete",
        [STR_SENSOR_TIMEOUT_LABEL] = "Timeout (5 min keine Daten)",
        [STR_SENSOR_TIMEOUT_SOURCE] = "Verbindungstimeout",
        [STR_STATUS_OK] = "OK",
        ...
        [STR_SENSOR_WAITING_HELLO] = "Warte auf Sensorboard",
        [STR_SENSOR_INVALID_DATA] = "Ungültige Sensordaten",
        [STR_WEEKDAY_SUN] = "So",
        [STR_WEEKDAY_MON] = "Mo",
        [STR_WEEKDAY_TUE] = "Di",
        [STR_WEEKDAY_WED] = "Mi",
        ...
        [STR_SOUND_SECTION]  = "Töne",
        [STR_SOUND_TONES]    = "Systemtöne",
        [STR_SOUND_TOUCH_CLICK] = "Touch-Klick",
        [STR_BATTERY_KFZ]   = "Kfz",
    ...
    // English strings
    {
        ...
        [STR_BATTERY] = "Battery:",
        [STR_TANKS] = "Tanks:",
        [STR_SENSOR_WAITING] = "Sensor: Waiting...",
        [STR_SENSOR_PACKETS] = "Sensor: %lu packets",
        [STR_SENSOR_TIMEOUT_LABEL] = "Timeout (no data for 5 min)",
        [STR_SENSOR_TIMEOUT_SOURCE] = "Connection timeout",
        [STR_STATUS_OK] = "OK",
        ...
        [STR_SENSOR_WAITING_HELLO] = "Waiting for Sensorboard",
        [STR_SENSOR_INVALID_DATA] = "Invalid sensor data",
        [STR_WEEKDAY_SUN] = "Sun",
        [STR_WEEKDAY_MON] = "Mon",
        [STR_WEEKDAY_TUE] = "Tue",
        [STR_WEEKDAY_WED] = "Wed",
        ...
        [STR_SOUND_SECTION]  = "Sounds",
        [STR_SOUND_TONES]    = "System sounds",
        [STR_SOUND_TOUCH_CLICK] = "Touch click",
