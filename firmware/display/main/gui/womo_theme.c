...
static void init_twilight_colors(void)
{
    ...
    // 45 Farbstufen linearer Gradient: Nachtblau (0x191970) → Taghimmelblau (0x87CEEB)
    const uint32_t color_values[WOMO_CIVIL_TWILIGHT_MINUTES] = {
        0x191970, 0x1C1D73, 0x1E2176, 0x212578, 0x23297B, 0x262E7E,
        0x283281, 0x2B3684, 0x2D3A86, 0x303E89, 0x32428C, 0x35468F,
        0x374A92, 0x3A4E94, 0x3C5397, 0x3F579A, 0x415B9D, 0x445FA0,
        0x4663A2, 0x4967A5, 0x4B6BA8, 0x4E6FAB, 0x5074AE, 0x5378B0,
        0x557CB3, 0x5880B6, 0x5A84B9, 0x5D88BB, 0x5F8CBE, 0x6290C1,
        0x6494C4, 0x6799C7, 0x699DC9, 0x6CA1CC, 0x6EA5CF, 0x71A9D2,
        0x73ADD5, 0x76B1D7, 0x78B5DA, 0x7BB9DD, 0x7DBEE0, 0x80C2E3,
        0x82C6E5, 0x85CAE8, 0x87CEEB
    };
